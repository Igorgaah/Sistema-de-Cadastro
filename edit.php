...
<body>
    ...
    <div class="box">
        <form action="saveEdit.php" method="POST">
                ...
                <br><br>
                <label for="data_conclusao"><b>Data de Conclusao:</b></label>
                <input type="date" name="data_conclusao" id="data_conclusao" value=<?php echo $data_con;?> required>
                <br><br>
                <div class="inputBox">
                <label for="curriculo">Curriculo atual:</label>
                </div>
                <br><br>
